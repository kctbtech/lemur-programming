...
tokens = []
variables = {}
functions = ["echo","calculation_show","calculation_hide","assign_math","assign_string","math_echo", "increase_var", "decrease_var", "check", "returned_true", "input", "do"]
...
def parse(data):
    ...
    while (i < len(data)):
        if "echo" in data[i] and not "math" in data[i]:
            ...
            tempi = i
            while("breakdo" not in data[tempi] or not tempi <= 999999999):
                tempi += 1
            repeatend = tempi
            sofar = 0
            i+=2
...
if typeof == "shell":
    ...
    file = "/Users/kieranblackley/Downloads/LemurPrograms/" + input("Please specify a file name for your program: ")
